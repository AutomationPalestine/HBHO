...
import com.hbho.qa.pages.ChequeStopPage;
import com.hbho.qa.pages.EnvironmentPage;
import com.hbho.qa.pages.HomePage;
import com.hbho.qa.pages.LoginPage;
import com.hbho.qa.pages.PaymentFlow;
import com.hbho.qa.pages.SchedulePage;
...
public class InwardPaymentFlowStepDefinition extends TestBase{
	...
	@Then("validate whether payment move to QueuedToInitialPosting status using {string},{string},{string},{string},{string},{string}")
	...
	public void validate_whether_payment_move_to_SignatureCheckApprove_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		...
		paymentFlow=paymentFlow.SignatureCheckQueueConfirm(ValueDateperiod,PaymentType, Reference, SubRef, ChequeNo, AccountNumber);
	}

	@Then("validate whether payment move to PendingSettlement using {string},{string},{string},{string},{string},{string}")
	...
	public void validate_whether_payment_move_to_InsufficientFund_status_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		...
		driver.switchTo().frame("toc");
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		paymentFlow=homePage.clickonBranchTechnicalApproveLink();
		paymentFlow=paymentFlow.movetoInsufficientFund(ValueDateperiod, PaymentType, Reference, SubRef, ChequeNo, AccountNumber);
	}

	@Then("validate whether payment move to InsufficientFundApprove status {string},{string},{string},{string},{string},{string}")
	...
	@Then("validate whether payment move to PendingSettlement status using {string},{string},{string},{string},{string},{string}")
	public void validate_whether_payment_move_to_PendingSettlement_status_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Initialization();
		win = new Windowhandle(driver);
		loginPage = new LoginPage();
		homePage = loginPage.login(prop.getProperty("username1"), prop.getProperty("password1"));
	...
	@Then("validate whether payment move to PendingSettlement queue using {string},{string},{string},{string},{string},{string}")
	public void validate_whether_payment_move_to_PendingSettlement_queue_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Initialization();
		win = new Windowhandle(driver);
		loginPage = new LoginPage();
		String title = driver.getTitle();
	...
	@Then("validate whether payment move to InsufficientFund using {string},{string},{string},{string},{string},{string}")
	public void validate_whether_payment_move_to_InsufficientFund_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Initialization();
		win = new Windowhandle(driver);
		loginPage = new LoginPage();
		String title = driver.getTitle();
	...
	public void validate_whether_payment_move_to_InsufficientFundApprove_status_after_gets_rejected_from_InsufficientFund_queue_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber,String ReasonCode1, String ReasonCode2,
	...
	public void validate_whether_payment_move_to_QueuedToFinalPosting_from_InsufficientFundApprove_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Initialization();
		win = new Windowhandle(driver);
		loginPage = new LoginPage();
		String title = driver.getTitle();
	...
	public void to_return_cheque_from_Qualify_Receive_queue_using(String ValueDateperiod,String PaymentType, String Reference, String SubRef, String ChequeNo, String AccountNumber,String ReasonCode1, String ReasonCode2,
			String ReasonCode3, String ReasonCode4, String ReasonCode5, String ReasonCode6, String ReasonCode7,
			String ReasonCode8, String ReasonCode9, String ReasonCode10, String ReasonCode11, String ReasonCode12,
			String ReasonCode13, String ReasonCode14, String ReasonCode15) throws InterruptedException {
		paymentFlow=paymentFlow.logout();
