...
public class ScheduleStepDefinition extends TestBase {
	...
	public void user_modify_FINAL__ISF_SCHEDULER_scheduler_with(String SchedulerStatus, String StartTime, String EndTime, String FrequencyHH, String FrequencyMM, String FrequencySS, String SettlementCycle,DataTable credentials) throws InterruptedException {
		schedulePage=schedulePage.modifyFINAL_ISF_SCHEDULERScheduler(credentials);
	}
	...
	public void user_modify_ISRAELI_CHEQUE_STOP_SCHEDULER_scheduler_with(String SchedulerStatus, String StartTime, String EndTime, String FrequencyHH, String FrequencyMM, String FrequencySS, String SettlementCycle,DataTable credentials) throws InterruptedException {
		schedulePage=schedulePage.modifyISRAELI_CHEQUE_STOP_SCHEDULERScheduler(credentials);
	}
