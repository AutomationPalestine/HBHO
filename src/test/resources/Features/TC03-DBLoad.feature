...
Feature: DBload feature
  ...
  Scenario Outline: To upload Participant banks through DBLoad
    ...
    Examples: 
      ...
      | PARTICIPANT_BANKCODE        | Y           | E:\Palestine\HBHO\STATIC-DATA-DIR\Participant List_local.csv |
  ...
  Scenario Outline: To upload Participant banks through DBLoad
    ...
    | Loadtype                    | ForceUpdate| FileName                                                         |
    |ISRAELI_PARTICIPANT_BANKCODE | Y           | E:\Palestine\HBHO\STATIC-DATA-DIR\israeliBankss.csv          |
