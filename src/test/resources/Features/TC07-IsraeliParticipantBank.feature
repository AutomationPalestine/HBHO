...
#
  ...
  Scenario: To Add Participant Bank with Invalid data
    ...
    Then User enter valid "BankCode" ,"Name","ShortName" fields in IsraeliBankPage and click on OK button to validate SwiftCode field
       |LUMIILIT657890| 10   |Mercantile Discount Bank Ltd   | LUMI10000 |#already existing
       |BYAHILIT      | 10   |Mercantile Discount Bank Ltd   | LUMI10000 |#eight digit
       |ALDNPS2012345 | 10   | Mercantile Discount Bank Ltd  | LUMI10000 |#random(incorrect one)
