...
public class PaymentFlow extends TestBase {
	...
	@FindBy(name="sendToBranchBtn")
	WebElement sendToBranchBtn;
	...
	WebElement allowDuplicateBtnfromRepair;
	...
	@FindBy(xpath="//*[@id=\"LNTablelistable\"]/tbody/tr[2]/td[23]")
	...
	@FindBy(name="btnOk")
	WebElement confirmBtnfromRepair;

	@FindBy(name = "Return")
	WebElement returnBtn;
	
	@FindBy(name="content(payerNationalityId)")
	WebElement payerNationalityId;
	
	@FindBy(name="content(payerIdType)")
	WebElement payerIdType;
	
	@FindBy(name="content(payerIdNo)")
	WebElement payerIdNo;

	@FindBy(name="return")
	WebElement insuffifundreturnBtn;
	
	@FindBy(name="return")
	WebElement branchtechnicalreturnBtn;
	...
	@FindBy(name="btnOk")
	WebElement insuffOKBtn;
	
	@FindBy(name="btnOk")
	WebElement insuffConfirmOKBtn;
	...
	public PaymentFlow signatureCheckQueue_Confirm(String ValueDateperiod,String PaymentType, String Reference,
		...
		record.click();
		Thread.sleep(IntfConstants.TIMEOUT);
//		if (ExpectedConditions.elementToBeClickable(confirmBtn).equals(true))
//        {
			confirmBtn.click();
//        }else {
...
//		String expectedCancelmsg = "Operation was cancelled.";
//		if (actualCancelmsg.equals(expectedCancelmsg)) {
//			System.out.println("Cancel Button from Branch Technical Approve screen is working fine");
//		} else {
//			System.out.println("Cancel Button from Branch Technical Approve screen is not working");
//		}
		record.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		skipBtn.click();
		String actualtitlemsg = message.getText();
		String expectedtitlemsg = "Branch Technical Approve";
		if (actualtitlemsg.equals(expectedtitlemsg)) {
			System.out.println("Payment gets skipped and came back to list");
		} else {
			System.out.println("Skip button from Branch Technical Approve screen is not working");
		}
		record.click();
		Thread.sleep(IntfConstants.TIMEOUT);
		approveBtn.click();
	...
	public PaymentFlow SignatureCheckQueue_Return(String ValueDateperiod,String PaymentType, String Reference,
		...
		if (actualalertmsg.equals(expectedalertmsg)) {
			...
			if(SignatureCheckScreenText.getText().equals(signatureCheckScreenText))
			{
				...
				Thread.sleep(IntfConstants.SHORT_TIMEOUT);
				returnBtn.click();
				String actualalertmsg2 = alertmsg.getText();
				String expectedalertmsg2 = "Enter Reason for sending to Return";
				if (actualalertmsg2.equals(expectedalertmsg2)) {
					System.out.println("Alert message is displayed for Reason field");
					reasonCode.click();
					Select sl2 = new Select(reasonCode);
					sl2.selectByVisibleText(ReasonCode1);
					sl2.selectByVisibleText(ReasonCode2);
					sl2.selectByVisibleText(ReasonCode3);
					sl2.selectByVisibleText(ReasonCode4);
					sl2.selectByVisibleText(ReasonCode5);
					sl2.selectByVisibleText(ReasonCode6);
					sl2.selectByVisibleText(ReasonCode7);
					sl2.selectByVisibleText(ReasonCode8);
					sl2.selectByVisibleText(ReasonCode9);
					sl2.selectByVisibleText(ReasonCode10);
					sl2.selectByVisibleText(ReasonCode11);
					sl2.selectByVisibleText(ReasonCode12);
					sl2.selectByVisibleText(ReasonCode13);
					sl2.selectByVisibleText(ReasonCode14);
					sl2.selectByVisibleText(ReasonCode15);
					Thread.sleep(IntfConstants.SHORT_TIMEOUT);
					reasonCode.click();
					Thread.sleep(IntfConstants.SHORT_TIMEOUT);
					returnBtn.click();
...
//			qualifyreceiveokBtn.click();
	...
	public PaymentFlow returnfromQualifyReceive(String ValueDateperiod,String PaymentType, String Reference, String SubRef,
		...
		if (actualalertmsg.equals(expectedalertmsg)) {
			...
			driver.switchTo().alert().accept();
			Thread.sleep(IntfConstants.SHORT_TIMEOUT);
			payerNationalityId.sendKeys("PS");
			payerIdType.click();
			Select sl1=new Select(payerIdType);
			sl1.selectByVisibleText("Passport");
			payerIdNo.sendKeys("1234567890");
			Thread.sleep(IntfConstants.SHORT_TIMEOUT);
			returnBtn.click();
		} else {
			System.out.println("Validation failed for Return reason field");
...
//		if(actualerrormsg.contains(expectederrormsg)) {
		...
		valuedateBtn.sendKeys(ValueDate);
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		allowDuplicateBtnfromRepair.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		confirmBtnfromRepair.click();
		logOutBtn.click();
		logoutBtn.click();
		driver.quit();
//	}
	...
	public PaymentFlow movetoBranchTechnical(String ValueDateperiod,String PaymentType, String Reference,
			String SubRef, String ChequeNo, String AccountNumber,String ReasonCode1, String ReasonCode2,
			String ReasonCode3, String ReasonCode4, String ReasonCode5, String ReasonCode6, String ReasonCode7,
			String ReasonCode8, String ReasonCode9, String ReasonCode10, String ReasonCode11, String ReasonCode12,
			String ReasonCode13, String ReasonCode14, String ReasonCode15) throws InterruptedException {
...
//		skipBtn.click();
//		String actualtitlemsg = message.getText();
//		String expectedtitlemsg = "Signature Check";
//		if (actualtitlemsg.equals(expectedtitlemsg)) {
//			System.out.println("Payment gets skipped and came back to list");
//		} else {
//			System.out.println("Skip button from SignatureCheck screen is not working");
//		}
//		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		record.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		sendToBranchBtn.click();
		String actualalertmsg = alertmsg.getText();
		String expectedalertmsg = "Enter Reason for sending to Send To Branch";
		if (actualalertmsg.equals(expectedalertmsg)) {
			System.out.println("Alert message is displayed for Reason field");
			reasonCode.click();
			Select sl = new Select(reasonCode);
		...
		if(SignatureCheckScreenText.getText().equals(signatureCheckScreenText))
		{
			...
			sendToBranchBtn.click();
			String actualalertmsg2 = alertmsg.getText();
			String expectedalertmsg2 = "Enter Reason for sending to Send To Branch";
			if (actualalertmsg2.equals(expectedalertmsg2)) {
				System.out.println("Alert message is displayed for Reason field");
				reasonCode.click();
				Select sl2 = new Select(reasonCode);
	...
	public PaymentFlow movetoBranchTechnicalApprove(String ValueDateperiod,String PaymentType, String Reference,
			String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		filterScreen1(ValueDateperiod,PaymentType, Reference, SubRef, ChequeNo, AccountNumber);
//		record.click();
...
//		String expectedCancelmsg = "Operation was cancelled.";
//		if (actualCancelmsg.equals(expectedCancelmsg)) {
//			System.out.println("Cancel Button from Branch Technical screen  is working fine");
//		} else {
//			System.out.println("Cancel Button from Branch Technical screen is not working");
//		}
//		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		record.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		skipBtn.click();
		String actualtitlemsg = message.getText();
		String expectedtitlemsg = "Branch Technical";
		if (actualtitlemsg.equals(expectedtitlemsg)) {
			System.out.println("Payment gets skipped and came back to list");
		} else {
			System.out.println("Skip button from Branch Technical screen is not working");
		}
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		record.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
	...
	public PaymentFlow rejectfromBranchTechnical(String ValueDateperiod,String PaymentType, String Reference,
			String SubRef, String ChequeNo, String AccountNumber,String ReasonCode1, String ReasonCode2,
			String ReasonCode3, String ReasonCode4, String ReasonCode5, String ReasonCode6, String ReasonCode7,
			String ReasonCode8, String ReasonCode9, String ReasonCode10, String ReasonCode11, String ReasonCode12,
			String ReasonCode13, String ReasonCode14, String ReasonCode15) throws InterruptedException {
...
//		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		...
		record.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		branchtechnicalreturnBtn.click();
		String actualalertmsg = alertmsg.getText();
		String expectedalertmsg = "Enter Reason for sending to Return";
		if (actualalertmsg.equals(expectedalertmsg)) {
			System.out.println("Alert message is displayed for Reason field");
			...
			System.out.println("Validation failed for reason field");
		}
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		logOutBtn.click();
		logoutBtn.click();
	...
	public PaymentFlow SignatureCheckQueueConfirm(String ValueDateperiod,String PaymentType, String Reference,
			String SubRef, String ChequeNo, String AccountNumber) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		filterScreen1(ValueDateperiod,PaymentType, Reference, SubRef, ChequeNo, AccountNumber);
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
