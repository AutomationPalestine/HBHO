...
public class HomePage extends TestBase {
	...
	@FindBy(xpath = "//*[@id=\"menuBody\"]/table/tbody/tr[10]/td[4]/a")
	...
	WebElement branchTechnicalLink;
	
	@FindBy(xpath="//a[contains(text(),'Branch Technical Approve')]")
	WebElement branchTechnicalApproveLink;
...
//		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
	...
	public PaymentFlow clickonBranchTechnicalLink() throws InterruptedException {
		applicationLink.click();
		paymentLink.click();
		branchTechnicalLink.click();
		win.handlewin();
		return new PaymentFlow();
	}
	
	public PaymentFlow clickonBranchTechnicalApproveLink() throws InterruptedException {
		applicationLink.click();
		paymentLink.click();
		branchTechnicalApproveLink.click();
		win.handlewin();
		return new PaymentFlow();
	}
