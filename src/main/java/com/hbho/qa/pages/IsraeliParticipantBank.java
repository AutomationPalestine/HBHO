...
public class IsraeliParticipantBank extends TestBase{
	...
	public IsraeliParticipantBank() {
		PageFactory.initElements(driver, this);
	}

	public IsraeliParticipantBank IsraeliparticipantBankListwithvaliddata(String SwiftCode,String BankCode,String ShortName) throws InterruptedException {
	...
	public IsraeliParticipantBank IsraeliparticipantBankListwithinvaliddata(String SwiftCode,String BankCode,String ShortName) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		cancelBtn.click();
		String a="Operation Cancelled";
		String b=cancelbtnmsg.getText();
	...
	public IsraeliParticipantBank addvalidIsraeliParticipantbankdata(String SwiftCode,String BankCode,String Name,String ShortName) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		cancelBtn.click();
	...
	public IsraeliParticipantBank addvalidIsraeliParticipantbankdata1(String SwiftCode,String BankCode,String Name,String ShortName,String BankType,String BranchCode) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		cancelBtn.click();
		String a=errormessages.getText();
		String b="Operation was cancelled.";
	...
	public IsraeliParticipantBank approveIsraeliParticipantBank(String SwiftCode) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
//		cancelBtn.click();
//		String a=errormessages.getText();
//		String b="Operation was cancelled.";
...
//		restartWorkflow.click();
	...
	public IsraeliParticipantBank repairIsraeliParticipantBank(String SwiftCode) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		swiftCode.sendKeys(SwiftCode);
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		okBtn.click();
	...
	public IsraeliParticipantBank modifyIsraeliParticipantBank(String SwiftCode,String Name,String BankCode,String BranchCode,String ShortName) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		swiftCode.sendKeys(SwiftCode);
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		resetBtn.click();
	...
	public IsraeliParticipantBank modifywithinvaliddata(String SwiftCode,String BankCode,String BranchCode) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		swiftCode.sendKeys(SwiftCode);
		okBtn.click();
		revealrecord.click();
		...
		if(c.equals(d)) {
			System.out.println("Branch Code length validation message is displayed proper");
		}
	...
	public IsraeliParticipantBank modifywithinvaliddata1(DataTable credentials) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		...
		String c=errormessages.getText();
		String d="Branch Code length should be 3 digit";
		String e="Branch code does not match with swift code";
		
		if(c.equals(d)) {
			System.out.println("Branch code length validation is proper");
		}
		else if(c.contains(d) && c.contains(e))
		{
			System.out.println("Validation Message Displayed proper for Branch Code with Swift code");
		}
		else {
			System.out.println("Branch code length validation is not proper");
		}
	...
	public IsraeliParticipantBank modifywithinvaliddata2(DataTable credentials) throws InterruptedException {
		restartWorkflow.click();
		List<List<String>> data=credentials.asLists();
		swiftCode.sendKeys(data.get(0).get(0));
		okBtn.click();
	...
	public IsraeliParticipantBank modifyIsraeliParticipantBank1(String SwiftCode,String Name,String BankCode,String BankType,String BranchCode,String ShortName) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		swiftCode.sendKeys(SwiftCode);
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		resetBtn.click();
	...
	public IsraeliParticipantBank validateSwiftCodefield(DataTable credentials) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		List<List<String>> data=credentials.asLists();
		swiftCode.sendKeys(data.get(0).get(0));
		bankCode.sendKeys(data.get(0).get(1));
	...
	public IsraeliParticipantBank validateBankCodefield(DataTable credentials) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		List<List<String>> data=credentials.asLists();
		swiftCode.sendKeys(data.get(0).get(0));
		bankCode.sendKeys(data.get(0).get(1));
	...
	public IsraeliParticipantBank validateNamefield(DataTable credentials) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		List<List<String>> data=credentials.asLists();
		swiftCode.sendKeys(data.get(0).get(0));
		bankCode.sendKeys(data.get(0).get(1));
	...
	public IsraeliParticipantBank validateShortNamefield(DataTable credentials) throws InterruptedException {
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		List<List<String>> data=credentials.asLists();
		swiftCode.sendKeys(data.get(0).get(0));
		bankCode.sendKeys(data.get(0).get(1));
	...
	public IsraeliParticipantBank listIsraeliParticipantBank() throws InterruptedException {
		okBtn.click();
		Thread.sleep(IntfConstants.SHORT_TIMEOUT);
		logOutBtn.click();
		logoutBtn.click();
