...
Feature: Inward Payment flow feature
 ...
 @TC_14_13_DuplicateCheque
  Scenario Outline: Inward Payment flow for Duplicate Cheque(check amount>x)
  ...
  Scenario Outline: Inward Payment flow for sending Duplicate Cheque to Qualify Receive queue
    ...
    Examples: 
      ...
      |                 | ACH CHEQUE RECEIVE | Cheque No | EQUAL  | 30000002 |               | Return |
      |                 | ACH CHEQUE RECEIVE | Cheque No | EQUAL  | 30000003 |               | Return |
...
#button issue/configuration issue
    #Examples: 
      ...
      #|                 | ACH CHEQUE RECEIVE | Cheque No | EQUAL  | 30000002 |               | 19/01/21  | TNBCPS20006  |  1001005616 |
...
#Payer details are mandatory while returning paymnent
  ...
  Scenario Outline: Check Stop cheque functionality for Inward flow
    ...
    Examples: 
      ...
      | HBHOPS20 |        410 | ILS      |            30000010 |            30000010 |               |                 | ACH CHEQUE RECEIVE | Cheque No | EQUAL  | 30000010 |