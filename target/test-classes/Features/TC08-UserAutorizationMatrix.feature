...
Feature: User Autorization Matrix feature
  ...
  Scenario: To add User Autorization Matrix with Valid data
    ...
    Then User enter valid data in "Name","Stages","PaymentTypes" fields for user "Maker1"
      | Test1           | LIST                 | REPAIR                      | TRANSACTION DETAIL REPORT | DUPLICATE | DELETE PDC | MODIFY PDC | BATCH MODIFY | TRANSACTION REPORT | HOLD  |
  ...
  Scenario: To add User Autorization Matrix with Valid data
    ...
    Then User pass data in "Name","Stages","PaymentTypes" fields for user "Maker3"
      | Test5           | LIST                  | REPAIR                       | TRANSACTION DETAIL REPORT | QUALIFY RECEIVE | DUPLICATE | INSUFFICIENT FUND | SIGNATURE CHECK | DELETE PDC | MODIFY PDC | BATCH MODIFY | TRANSACTION REPORT | HOLD |
